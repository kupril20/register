        ...
        padding: 50px;">
          <form method="post">    
              <div class="divider d-flex align-items-center my-4">
                <p class="text-center fw-bold mx-3 mb-0">Buat Akun</p>
              </div>
              ...
              <div class="text-center text-lg-start mt-4 pt-2">
                <button name="tambah"  class="btn btn-primary btn-lg"
                  style="padding-left: 2.5rem; padding-right: 2.5rem;">Buat Akun</button>
               
                  <p class="small fw-bold mt-2 pt-1 mb-0">Sudah punya akun ? Klik <a href="index.php"
    ...
    <?php
        if (isset($_POST['tambah'])) {
          ...
          if (empty($username && $password)) {
            echo "<script>alert('Data Tidak boleh Kosong');window.location='register.php'</script>";
        } else {
